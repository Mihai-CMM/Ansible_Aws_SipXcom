...
We will use Ansible website’s well written documentation and examples found here:
http://docs.ansible.com/ansible/guide_aws.html 

We’ve also utilized knowledge shared by linuxacademy on various channels. 

PART 1- Provisioning a minimal CentOS machine with Ansible-AWS,  used to create our own sipXcom based AMI 
...
Don’t miss what’s coming in the next blog entry! :)
End of Part 1. 
Part 2 - Creating SipXcom based AMI
...
Don’t miss Part 3 where we will create an EC2 instance from sipXcom template and configure newly launched server
...
Don’t miss next blog article  where we will use route 53 to connect to sipxcom instance.
End of Part 3.
...
End of part 5 and series 
 ...
 TODO: Write some ansible modules for sipxcom 
